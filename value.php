<?php
// Script Created By Usman Shabbir// to use this script just attach it with the simple bot script and use the iphone on that script it will get tokens from cokis
...
echo "Creat By Usman Shabbir :) facebook.com/usman.shabbi";
function puaru($url){
$data = curl_init();
...
// Created With a lot OF <3 and Coffee ;) ( Regards : Shabb ) 
?>
